...
export default function Sidebar({menuSidebar, submenuSidebar}) {
    ...
    const pages = [
        {
            'menu': 'Aulas',
            'icone': <DescriptionOutlinedIcon style={{color: 'white'}}/>,
            'tagMenu': 'aulas',
            'url': route('alunos.aulas.index'),
            'submenu': []
        }, {
            'menu': 'Avaliações',
            'icone': <RuleOutlinedIcon style={{color: 'white'}} color=""/>,
            'url': route('alunos.avaliacoes.index'),
            'tagMenu': 'avaliacoes',
            'submenu': []
        }, {
            'menu': 'Mensalidades',
            ...
            'url': route('alunos.mensalidades.index'),
            'submenu': []
        }, {
            'menu': 'Perfil',
            'icone': <PersonOutlineOutlinedIcon style={{color: 'white'}} color=""/>,
            'url': route('alunos.perfil.index'),
            'tagMenu': 'perfil',
            'submenu': [
